...
const blocks = [
  ...
  },
  {
    ...
    slide: "Слайды 3–4 · Сценарий и находка",
  ...
  },
  {
    ...
    lines: [
      ...
      "Важно: первые два слоя — обычный код, они детерминированы и воспроизводимы. LLM отвечает только за смысл, и у него жёсткое правило — каждое замечание обязано содержать дословную цитату, иначе оно отбрасывается.",
  ...
  },
  {
    time: "4:10 – 5:00",
    title: "Финал",
    slide: "Слайды 6–7 · Метрики и готовность",
