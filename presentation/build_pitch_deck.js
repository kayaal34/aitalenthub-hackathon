...
/* ===================================================== 7 · Архитектура */
{
  ...
  chrome(s);
  s.addNotes("3:10–4:10. Первые два слоя — обычный код, детерминированы и воспроизводимы. LLM отвечает только за смысл; промпт требует к каждому замечанию дословную цитату — в наших прогонах её содержали все двадцать. Провайдера меняли на живой Gemini без единой правки кода.");
}
